...
def load_data(data_directory):
    ...
    in_frames = np.zeros(shape=(0, 160, 320, 6))
    out_frames = np.zeros(shape=(0, 160, 320, 3))
    
    num_files = 0

    t1 = np.zeros(shape=(160, 320, 3))
    t2 = np.zeros(shape=(160, 320, 3))
    t = np.zeros(shape=(160, 320, 3))
    ...
    for f in files:
        ...
        if num_files%3==0:
            ...
            out_frames = np.append(out_frames, img, axis=0)
        elif num_files%3==2:
            t2 = img
            t = get_input_frames(t1, t2)
            t = t.reshape((1, 160, 320, 6))
...
data_dir = 'F:\\Machine Learning\\VFI\\2011_09_26_drive_0018_sync\\JPEG'
